...
/*
        ...
        Flowchart:
   https://excalidraw.com/#json=J1-kzw-6jBQf_Iz5Z_ilw,RUl6XdgD927zZdv_u9VqVQ
 */
...
int bookedTkt() { printf("Enter the Train no. to book ticket\n"); }
int cancelTkt() { printf("Enter the Train no. to book ticket\n"); }
